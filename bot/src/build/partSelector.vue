<template>
  <div class="part" :class="position">
    <router-link :to="{
      ...
      <img :src=" this.selectedPart.src" title="this.selectedPart.title"/>
    </router-link>
    ...
    <span @click=" pinPadding = '30px' "
      v-pin="{top: pinPadding, right: pinPadding}" class="price">
      {{ this.selectedPart.cost | usd('$') }}
    </span>
  </div>
</template>
